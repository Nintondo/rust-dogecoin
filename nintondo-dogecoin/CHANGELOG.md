...
- API improvements:
  ...
  - [Add CentiDogecoin to denominations](https://github.com/rust-bitcoin/rust-bitcoin/pull/1715)
...
- [Introduce some policy constants from Dogecoin Core](https://github.com/rust-bitcoin/rust-bitcoin/pull/584)
...
- [Remove](https://github.com/rust-bitcoin/rust-bitcoin/pull/385) the `DogecoinHash` trait
...
* [Significant API overhaul](https://github.com/rust-bitcoin/rust-bitcoin/pull/156):
    ...
    * Move `DogecoinHash` from `network::serialize` to `util::hash`; remove impl for `Vec<u8>`
...
* Add witness inv types to inv enum, constants for Dogecoin regtest network, `is_coin_base` accessor for tx inputs
...
* A new optional feature "bitcoinconsensus" lets this library use Dogecoin Core's native
