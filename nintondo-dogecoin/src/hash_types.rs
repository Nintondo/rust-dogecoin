...
mod newtypes {
    ...
    hash_newtype! {
        ...
        ///
        /// For compatibility with the existing Dogecoin infrastructure and historical
        /// and current versions of the Dogecoin Core software itself, this and
        ...
        /// A hash of Dogecoin Script bytecode.
        pub struct ScriptHash(hash160::Hash);
        /// SegWit version of a public key hash.
        pub struct WPubkeyHash(hash160::Hash);
        /// SegWit version of a Dogecoin Script bytecode hash.
