...
///
/// The inner value is a signed integer in Dogecoin Core for historical reasons, if version bits is
...
impl Version {
    /// The original Dogecoin Block v1.
...
///
/// See [Dogecoin Wiki: Block][wiki-block] for more information.
///
