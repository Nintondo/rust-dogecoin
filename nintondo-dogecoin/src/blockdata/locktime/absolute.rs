// Rust Dogecoin Library - Written by the rust-bitcoin developers.
...
/// The Threshold for deciding whether a lock time value is a height or a time (see [Dogecoin Core]).
///
...
///
/// Dogecoin is able to safely use this value because a block height greater than 500,000,000 would
...
/// are, for obvious reasons, not useful within the Dogecoin network.
///
/// [Dogecoin Core]: https://github.com/bitcoin/bitcoin/blob/9ccaee1d5e2e4b79b0a7c29aadb41b97e4741332/src/script/script.h#L39
...
/// since epoch).
///
/// Used for transaction lock time (`nLockTime` in Dogecoin Core and [`crate::Transaction::lock_time`]
...
/// # Examples
/// ```
/// # use nintondo_dogecoin::absolute::{LockTime, LockTime::*};
...
pub enum LockTime {
    ...
    /// # Examples
    /// ```rust
    /// use nintondo_dogecoin::absolute::LockTime;
    ///
...
impl LockTime {
    ...
    /// # Examples
    /// ```no_run
    /// # use nintondo_dogecoin::absolute::{LockTime, Height, Time};
...
impl Height {
    ...
    /// # Examples
    /// ```rust
    /// use nintondo_dogecoin::locktime::absolute::Height;
    ///
    /// let h: u32 = 741521;
...
impl Time {
    ...
    /// # Examples
    /// ```rust
    /// use nintondo_dogecoin::locktime::absolute::Time;
    ///
