...
mod test {
    ...
    fn bitcoin_genesis_full_block() {
        let gen = genesis_block(Network::Dogecoin);
    ...
    chain_hash_genesis_block! {
        mainnet_chain_hash_genesis_block, Network::Dogecoin;
    ...
    fn mainnet_chain_hash_test_vector() {
        let got = ChainHash::using_genesis_block(Network::Dogecoin).to_string();
