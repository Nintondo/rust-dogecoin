...
/// Dogecoin script slice.
///
/// *[See also the `nintondo_dogecoin::blockdata::script` module](crate::blockdata::script).*
///
...
impl Script {
    ...
    /// broadcastable on today's Dogecoin network.
    pub fn dust_value(&self) -> crate::Amount {
        // This must never be lower than Dogecoin Core's GetDustThreshold() (as of v0.21) as it may
