...
// Copyright (c) 2009-2018 The Dogecoin Core developers
...
//!
//! ```rust
//! use nintondo_dogecoin::hash_types::Txid;
//! use nintondo_dogecoin::hashes::hex::FromHex;
//! use nintondo_dogecoin::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = nintondo_dogecoin::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = nintondo_dogecoin::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use nintondo_dogecoin::hash_types::Txid;
    /// use nintondo_dogecoin::hashes::hex::FromHex;
    /// use nintondo_dogecoin::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
