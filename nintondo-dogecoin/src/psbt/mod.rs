...
//!
//! Implementation of BIP174 Partially Signed Dogecoin Transaction Format as
...
/// Signing algorithms supported by the Dogecoin network.
#[derive(Clone, Copy, Debug, PartialEq, Eq, PartialOrd, Ord, Hash)]
...
mod tests {
    ...
    fn serialize_then_deserialize_output() {
        ...
        let mut sk: ExtendedPrivKey = ExtendedPrivKey::new_master(Dogecoin, &seed).unwrap();
