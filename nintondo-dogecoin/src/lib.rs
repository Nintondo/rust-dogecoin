...
//!
//! This is a library that supports the Dogecoin network protocol and associated
//! primitives. It is designed for Rust programs built to work with the Dogecoin
//! network.
//!
