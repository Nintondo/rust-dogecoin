...
//! Dogecoin consensus-encodable types.
//!
...
/// Extensions of `Write` to encode data as per Dogecoin consensus.
...
/// Extensions of `Read` to decode data as per Dogecoin consensus.
