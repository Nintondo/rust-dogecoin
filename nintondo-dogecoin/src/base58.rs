...
mod tests {
    ...
    fn test_base58_encode() {
        ...
        let res = encode(
            "DogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinBit\
        coinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoinDogecoin"
                .as_bytes(),
        );
        let exp =
